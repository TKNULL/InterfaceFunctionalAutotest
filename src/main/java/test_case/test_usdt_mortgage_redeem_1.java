...
public class test_usdt_mortgage_redeem_1 {
    public static Log log = LogFactory.getLog(test_usdt_mortgage_redeem_1.class);
    ...
    public void usdt_mortgage_redeem_1_1(ITestContext context) throws IOException, InterruptedException {
        log.info("usdt_mortgage_redeem_1_1:承兑用户登录，查看USDT余额，有余额的话，点击进行抵押，抵押全部");
        ...
        log.info("usdt_mortgage_redeem_1_1,执行抵押的USDT金额是:"+usdt_available);



        //进行抵押，抵押全部
        int getcode = eu_user.v1_usdt_mortgage(usdt_available);
        log.info("usdt_mortgage_redeem_1_1,返回的getcode是(200说明抵押成功)："+getcode);
        Assert.assertEquals(200,getcode);
        log.info("usdt_mortgage_redeem_1_1,测试结束");


    }


    @Test(dependsOnMethods = { "usdt_mortgage_redeem_1_1" },description = "抵押成功后，USDT预期：【资产】【USDT】可用余额为0"      )
    //二、抵押成功后，USDT预期：【资产】【USDT】可用余额为0
    public void usdt_mortgage_redeem_1_2(ITestContext context) throws IOException, InterruptedException {
        Thread.sleep(10*1000);
        log.info("usdt_mortgage_redeem_1_2:抵押成功后，USDT预期：【资产】【USDT】可用余额为0");
        String eu_token = (String) context.getAttribute("eu_token");
        User eu_user = new User(eu_token);
        // 获取现USDT可用余额，如果抵押成功的话，可用余额应该是0.0000
        BigDecimal before_usdt_available = eu_user.v1_usdt_return_available();
        log.info("usdt_mortgage_redeem_1_2,获得的可用余额(0.0000为正确)是："+before_usdt_available);
        ...
        log.info("usdt_mortgage_redeem_1_2,测试结束");
    }



    @Test(dependsOnMethods = { "usdt_mortgage_redeem_1_2" },description = "抵押成功后，USDT预期：【资产】【USDT】已抵押金额增加")
    //三、抵押成功后，USDT预期：【资产】【USDT】已抵押金额增加
    public void usdt_mortgage_redeem_1_3(ITestContext context) throws InterruptedException, IOException {
        log.info("usdt_mortgage_redeem_1_3:抵押成功后，USDT预期：【资产】【USDT】可用余额为0");
        Thread.sleep(10*1000);
        String eu_token = (String) context.getAttribute("eu_token");
        ...
        log.info("usdt_mortgage_redeem_1_3,原已抵押金额 +  本次抵押金额 = 现已抵押金额，测试通过,参与计算的数值是：");
        log.info("usdt_mortgage_redeem_1_3,usdt_mortgaged是："+usdt_mortgaged);
        log.info("usdt_mortgage_redeem_1_3,usdt_available是："+usdt_available);
        log.info("usdt_mortgage_redeem_1_3,before_usdt_mortgaged："+before_usdt_mortgaged);
        if(usdt_mortgaged.add(usdt_available).compareTo(before_usdt_mortgaged)==0){
            Assert.assertTrue(true);
        }else{
            Assert.assertTrue(false);
        }
        log.info("usdt_mortgage_redeem_1_3,测试结束");
    }


    @Test(dependsOnMethods = { "usdt_mortgage_redeem_1_3" },description = "抵押成功后，USDT预期：【资产】【USDT】【资产详情】页面订单状态和类型为“抵押”“已抵押”")
    //四、抵押成功后，USDT预期：【资产】【USDT】【资产详情】页面订单状态和类型为“抵押”“已抵押”
    public void usdt_mortgage_redeem_1_4(ITestContext context) throws IOException, InterruptedException {
        log.info("usdt_mortgage_redeem_1_4,抵押成功后，USDT预期：【资产】【USDT】【资产详情】页面订单状态和类型为“抵押”“已抵押”");
        Thread.sleep(10*1000);
        String eu_token = (String) context.getAttribute("eu_token");
        User user = new User(eu_token);
        ...
        log.info("usdt_mortgage_redeem_1_4,抵押成功后，USDT预期：【资产】【USDT】【资产详情】页面订单状态(3为正确)是："+arr[0]);
        log.info("usdt_mortgage_redeem_1_4,抵押成功后，USDT预期：【资产】【USDT】【资产详情】页面订单类型是(2为正确)是："+arr[1]);
        if((arr[0]==3)&(arr[1]==2)){
            Assert.assertTrue(true);
        }else{
            Assert.assertTrue(false);
        }
        log.info("usdt_mortgage_redeem_1_4,测试结束");
    }



    @Test(dependsOnMethods = { "usdt_mortgage_redeem_1_4" },description = "抵押成功后，EUSD预期：【资产】【EUSD】可用余额不变")
    //五、抵押成功后，EUSD预期：【资产】【EUSD】可用余额不变
    public void usdt_mortgage_redeem_1_5(ITestContext context) throws IOException, InterruptedException {
        log.info("usdt_mortgage_redeem_1_5,抵押成功后，EUSD预期：【资产】【EUSD】可用余额不变");
        Thread.sleep(10*1000);
        String eu_token = (String) context.getAttribute("eu_token");
        User user = new User(eu_token);
        ...
        log.info("usdt_mortgage_redeem_1_5,参与比较的2个数值是（2个数值相等，则测试通过）：");
        log.info("usdt_mortgage_redeem_1_5，eusd_available是："+eusd_available);
        log.info("usdt_mortgage_redeem_1_5，before_eusd_availablee是："+before_eusd_available);
        if(eusd_available.compareTo(before_eusd_available)==0){
            Assert.assertTrue(true);
        }else{
            Assert.assertTrue(false);
        }
        log.info("usdt_mortgage_redeem_1_5,测试结束");
    }




    @Test(dependsOnMethods = { "usdt_mortgage_redeem_1_5" },description = "抵押成功后，EUSD预期：【资产】【EUSD】冻结余额+X")
    //六、抵押成功后，EUSD预期：【资产】【EUSD】冻结余额+X
    public void usdt_mortgage_redeem_1_6(ITestContext context) throws IOException, InterruptedException {
        log.info("usdt_mortgage_redeem_1_6,抵押成功后，EUSD预期：【资产】【EUSD】抵押余额增加");
        Thread.sleep(10*1000);
        String eu_token = (String) context.getAttribute("eu_token");
        User user = new User(eu_token);
        ...
        log.info("usdt_mortgage_redeem_1_6,抵押前eusd冻结余额 + 抵押金额 = 抵押后eusd冻结余额，测试通过,参与计算的数值是：");
        log.info("usdt_mortgage_redeem_1_6,eusd_frozen是："+eusd_frozen);
        log.info("usdt_mortgage_redeem_1_6,usdt_available是："+usdt_available);               //10000.0000
        log.info("usdt_mortgage_redeem_1_6,change_usdt_available是："+change_usdt_available);
        log.info("usdt_mortgage_redeem_1_6,before_eusd_frozen是："+before_eusd_frozen);       //10000 0000返回数据无小数点
        ...
        log.info("usdt_mortgage_redeem_1_6，测试完成");
    }




    @Test(dependsOnMethods = { "usdt_mortgage_redeem_1_6" },description = "抵押成功后，EUSD预期：5分钟后，【资产】【EUSD】可用余额+X")
    //七、抵押成功后，EUSD预期：5分钟后，【资产】【EUSD】可用余额+X
    public void usdt_mortgage_redeem_1_7(ITestContext context) throws IOException, InterruptedException {
        log.info("usdt_mortgage_redeem_1_7,抵押成功后，EUSD预期：5分钟后，【资产】【EUSD】可用余额+X");
        ...
        log.info("usdt_mortgage_redeem_1_7,原EUSD可用余额+USDT抵押数值=现EUSD可用余额，则测试通过，参与计算的数值是：");
        log.info("usdt_mortgage_redeem_1_7,eusd_available是："+eusd_available);
        log.info("usdt_mortgage_redeem_1_7,usdt_available是："+usdt_available);
        log.info("usdt_mortgage_redeem_1_7,before_eusd_available是："+before_eusd_available);
        ...
        log.info("usdt_mortgage_redeem_1_7，测试完成");

    }


    @Test(dependsOnMethods = { "usdt_mortgage_redeem_1_7" },description = "抵押成功后，EUSD预期：5分钟后，【资产】【EUSD】冻结金额-X")
    //八、抵押成功后，EUSD预期：5分钟后，【资产】【EUSD】冻结金额-X
    public void usdt_mortgage_redeem_1_8(ITestContext context) throws IOException {
        log.info("usdt_mortgage_redeem_1_8,抵押成功后，EUSD预期：5分钟后，【资产】【EUSD】冻结金额-X");
        //登录并等待5分钟（等解冻）
        String eu_token = (String) context.getAttribute("eu_token");
        User user = new User(eu_token);
        ...
        log.info("usdt_mortgage_redeem_1_8,现冻结金额+USDT抵押金额=原EUSD冻结金额，则测试通过。 参与比较的数值是：");
        log.info("usdt_mortgage_redeem_1_8,before_eusd_frozen_reduce是："+before_eusd_frozen_reduce);
        context.setAttribute("before_eusd_frozen_reduce",before_eusd_frozen_reduce);
        log.info("usdt_mortgage_redeem_1_8,usdt_available是："+usdt_available);
        log.info("usdt_mortgage_redeem_1_8,before_eusd_frozen是："+before_eusd_frozen);
        ...
        log.info("usdt_mortgage_redeem_1_8,测试结束");
    }
    ...
    @Test(dependsOnMethods = { "usdt_mortgage_redeem_1_8" },description = "抵押成功后，EUSD预期：【资产】【EUSD】【资产详情】页面显示记录")
    //九、抵押成功后，EUSD预期：【资产】【EUSD】【资产详情】页面显示记录
    public void usdt_mortgage_redeem_1_9(ITestContext context) throws IOException, InterruptedException {
        log.info("usdt_mortgage_redeem_1_9,抵押成功后，EUSD预期：【资产】【EUSD】【资产详情】页面显示记录");
        Thread.sleep(10*1000);
        String eu_token = (String) context.getAttribute("eu_token");
        User user = new User(eu_token);
        ...
        log.info("usdt_mortgage_redeem_1_9,抵押成功后，EUSD预期：【资产】【EUSD】【资产详情】页面订单状态(9为正确)是："+arr[0]);
        log.info("usdt_mortgage_redeem_1_9,抵押成功后，EUSD预期：【资产】【EUSD】【资产详情】页面订单类型是(1为正确)是："+arr[1]);
        if((arr[0]==9)&(arr[1]==1)){
            Assert.assertTrue(true);
        }else{
            Assert.assertTrue(false);
        }
        log.info("usdt_mortgage_redeem_1_9,测试结束");
    }
    ...
    //点击赎回
    @Test(dependsOnMethods = { "usdt_mortgage_redeem_1_9" },description = "赎回成功后，USDT预期：【资产】【USDT】已抵押余额为0")
    //十、赎回成功后，USDT预期：【资产】【USDT】已抵押余额为0
    public void usdt_mortgage_redeem_1_10(ITestContext context) throws IOException {
        log.info("usdt_mortgage_redeem_1_10,赎回成功后，USDT预期：【资产】【USDT】已抵押余额为0");
        String eu_token = (String) context.getAttribute("eu_token");
        User user = new User(eu_token);
        ...
        log.info("usdt_mortgage_redeem_1_10,v1_usdt_release的值(200则正确)是:"+v1_usdt_release);
        log.info("usdt_mortgage_redeem_1_10,after_usdt_mortgaged的值(0则正确)是:"+after_usdt_mortgaged);
        //获得现已抵押余额,=0则测试通过
        ...
        log.info("usdt_mortgage_redeem_1_10,测试结束");
    }



    @Test(dependsOnMethods = { "usdt_mortgage_redeem_1_10" },description = "赎回成功后，USDT预期：【资产】【USDT】【资产详情】页面订单状态为:为“抵押”“已抵押”")
    //十一、赎回成功后，USDT预期：【资产】【USDT】【资产详情】页面订单状态为:为“抵押”“已抵押”
    public void usdt_mortgage_redeem_1_11(ITestContext context) throws IOException, InterruptedException {
        log.info("usdt_mortgage_redeem_1_11,抵押成功后，USDT预期：【资产】【USDT】【资产详情】页面订单状态和类型为“抵押”“已抵押”");
        Thread.sleep(10*1000);
        String eu_token = (String) context.getAttribute("eu_token");
        User user = new User(eu_token);
        ...
        int arr[] = user.v1_usdt_records( amount);
        log.info("usdt_mortgage_redeem_1_11,抵押成功后，USDT预期：【资产】【USDT】【资产详情】页面订单状态(4为正确)是："+arr[0]);
        log.info("usdt_mortgage_redeem_1_11,抵押成功后，USDT预期：【资产】【USDT】【资产详情】页面订单类型是(5为正确)是："+arr[1]);
        if((arr[0]==4)&(arr[1]==5)){
            Assert.assertTrue(true);
        }else{
            Assert.assertTrue(false);
        }
        log.info("usdt_mortgage_redeem_1_11,测试结束");
    ...
    @Test(dependsOnMethods = { "usdt_mortgage_redeem_1_11" },description = "赎回成功后，EUSD预期：【资产】【EUSD】可用余额减少")
    //十二、赎回成功后，EUSD预期：【资产】【EUSD】可用余额减少
    public void usdt_mortgage_redeem_1_12(ITestContext context) throws IOException {
        log.info("usdt_mortgage_redeem_1_12,测试开始");
        String eu_token = (String) context.getAttribute("eu_token");
        User user = new User(eu_token);
        ...
        log.info("usdt_mortgage_redeem_1_12,进行数据转换");
        log.info("usdt_mortgage_redeem_1_12,dou_before_usdt_mortgaged:"+dou_before_usdt_mortgaged);
        //再转成String,并去除小数点和最后一位(因为转double的时候,会带XX.0)
        ...
        log.info("usdt_mortgage_redeem_1_12,str_before_usdt_mortgaged_2:"+str_before_usdt_mortgaged_2);
        //再转成BigDecimal进行比较
        BigDecimal bigDecimal_before_usdt_mortgaged_2 = new BigDecimal(str_before_usdt_mortgaged_2);
        log.info("usdt_mortgage_redeem_1_12,bigDecimal_usdt_available:"+bigDecimal_before_usdt_mortgaged_2);
        //数据拼接转换,//10000.0000==>100000000结束
        ...
        log.info("usdt_mortgage_redeem_1_12,前EUSD可用资产-赎回金额=现EUSD可用资产,则测试通过,参与计算的数值是:");
        log.info("usdt_mortgage_redeem_1_12,before_eusd_available是:"+before_eusd_available);
        log.info("usdt_mortgage_redeem_1_12,bigDecimal_before_usdt_mortgaged_2是:"+bigDecimal_before_usdt_mortgaged_2);        //数据可能不对,有加.
        log.info("usdt_mortgage_redeem_1_12,after_eusd_available是:"+after_eusd_available);
        if(before_eusd_available.subtract(bigDecimal_before_usdt_mortgaged_2).compareTo(after_eusd_available)==0){
            Assert.assertTrue(true);
        }else{
            Assert.assertTrue(false);
        }
        log.info("usdt_mortgage_redeem_1_12,测试结束");
    ...
    @Test(dependsOnMethods = { "usdt_mortgage_redeem_1_12" },description = "赎回成功后，EUSD预期：【资产】【EUSD】冻结金额不变")
    //十三、赎回成功后，EUSD预期：【资产】【EUSD】冻结金额不变
    public void usdt_mortgage_redeem_1_13(ITestContext context) throws IOException, InterruptedException {
        log.info("usdt_mortgage_redeem_1_13,赎回成功后，EUSD预期：【资产】【EUSD】冻结金额不变");
        String eu_token = (String) context.getAttribute("eu_token");
        User user = new User(eu_token);
        ...
        log.info("usdt_mortgage_redeem_1_13,现冻结金额+USDT抵押金额=原EUSD冻结金额，则测试通过。 参与比较的数值是：");
        log.info("usdt_mortgage_redeem_1_13,before_eusd_frozen_reduce是："+before_eusd_frozen_reduce);
        log.info("usdt_mortgage_redeem_1_13,after_eusd_frozen是："+after_eusd_frozen);
        //现冻结金额+USDT抵押金额=原EUSD冻结金额
        ...
        log.info("usdt_mortgage_redeem_1_13,测试结束");
    }




    @Test(dependsOnMethods = { "usdt_mortgage_redeem_1_13" },description = "赎回成功后，EUSD预期：【资产】【EUSD】【资产详情】页面显示记录"     )
    //十四、赎回成功后，EUSD预期：【资产】【EUSD】【资产详情】页面显示记录
    public void usdt_mortgage_redeem_1_14(ITestContext context) throws IOException, InterruptedException {
        log.info("usdt_mortgage_redeem_1_14,抵押成功后，EUSD预期：【资产】【USDT】【资产详情】页面显示记录");
        Thread.sleep(10*1000);
        String eu_token = (String) context.getAttribute("eu_token");
        User user = new User(eu_token);
        ...
        log.info("usdt_mortgage_redeem_1_14,抵押成功后，EUSD预期：【资产】【EUSD】【资产详情】页面订单状态(10为正确)是："+arr[0]);
        log.info("usdt_mortgage_redeem_1_14,抵押成功后，EUSD预期：【资产】【EUSD】【资产详情】页面订单类型是(1为正确)是："+arr[1]);
        if((arr[0]==10)&(arr[1]==1)){
            Assert.assertTrue(true);
        }else{
            Assert.assertTrue(false);
        }
        log.info("usdt_mortgage_redeem_1_14,测试结束");
    }
}
